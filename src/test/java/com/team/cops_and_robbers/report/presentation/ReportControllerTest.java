...
class ReportControllerTest extends ControllerTest {
    ...
    class ChatReport {
        ...
        void 신고에_성공하면_201을_응답한다() {
            ReportRequest request = new ReportRequest(game.getId(), reportedParticipant.getId(), "나쁜말 했어요");
        ...
        void 본인을_신고하면_400을_응답한다() {
            ...
            ReportRequest request = new ReportRequest(game.getId(), reporterParticipant.getId(), "나쁜말 했어요");
        ...
        void 게임이_진행중이_아니면_400을_응답한다() {
            ...
            ReportRequest request = new ReportRequest(waitingGame.getId(), target.getId(), "나쁜말 했어요");
