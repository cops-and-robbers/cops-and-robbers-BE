...
import com.team.cops_and_robbers.admin.application.AdminCommunityPostReportService;
...
public class AdminCommunityPostReportResolver {

    private final AdminCommunityPostReportService adminCommunityPostReportService;

    @QueryMapping
    public AdminCommunityPostReportPageResult adminCommunityPostReports(
        ...
        return adminCommunityPostReportService.getCommunityPostReportList(command);
    }

    @MutationMapping
    public AdminCommunityPostReportResult updateCommunityPostReportStatus(
        ...
        return adminCommunityPostReportService.updateCommunityPostReportStatus(command);
    }
}
