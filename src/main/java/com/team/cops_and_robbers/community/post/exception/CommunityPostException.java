package com.team.cops_and_robbers.community.post.exception;
...
public enum CommunityPostException implements ExceptionCode {
    ...
    COUNTRY_NOT_SPECIFIED(HttpStatus.BAD_REQUEST, "국가를 특정할 수 없음", "countryCode 또는 excludeCountryCodes 중 하나는 필수입니다."),
    CONFLICTING_COUNTRY_FILTER(HttpStatus.BAD_REQUEST, "국가 조건 충돌", "countryCode와 excludeCountryCodes는 함께 사용할 수 없습니다."),
