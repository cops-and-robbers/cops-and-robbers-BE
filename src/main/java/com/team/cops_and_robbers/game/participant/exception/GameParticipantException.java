...
public enum GameParticipantException implements ExceptionCode {
    ...
    INVALID_INVITE_CODE(HttpStatus.BAD_REQUEST, "초대 코드 오류", "입력하신 초대 코드가 유효하지 않습니다."),
    ...
    PARTICIPANT_GAME_MISMATCH(HttpStatus.BAD_REQUEST, "참가자 게임 불일치", "경찰과 도둑이 서로 다른 게임에 참여하고 있습니다."),
